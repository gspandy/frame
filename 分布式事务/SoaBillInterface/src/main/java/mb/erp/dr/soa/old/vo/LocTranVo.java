 ...
 * @since       全流通改造
 */
public class LocTranVo implements Serializable{
	/**
	 * 
	 */
	private static final long serialVersionUID = -3967280405028258052L;
	
	private String warehId ; // 仓库编码
	private Long locTranId ; // 货位事务编码
	...
	public Long getLocTranId() {
		return locTranId;
	}

	public void setLocTranId(Long locTranId) {
		this.locTranId = locTranId;
	}
