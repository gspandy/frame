...
/**
 * 已分配库存事务表vo(本表为本次新加表)
 * PK : ID   流水号：SF_WAREH_COMMIT_TRANID
 * @author     余从玉
 * @version    1.0, 2015-1-8
 * @since       全流通改造
 */
public class SfWarehCommitedTranVo implements Serializable {
	
    /**
	 * 
	 */
	private static final long serialVersionUID = -8547765208504794393L;
