					...
					<form class="form-horizontal" role="form">
						<fieldset>
							...
							<div class="form-group">
								...
								<div class="col-md-3">
									<select class="form-control" id="jiaoyifangshi">
									</select>
								</div>
	...
	<script type="text/javascript">
			...
			jQuery(function($) {
				...
				jQuery(grid_selector).jqGrid({
					...
					height: 250,
					emptyrecords:true,
					colNames:['操作列', 'ID','Last Sales','Name', 'Stock', 'Ship via','Notes'],
					colModel:[
						...
						{name:'sdate',index:'sdate',width:90, sortable:false,editable:true, sorttype:"date",formatter:'date',formatoptions:{srcformat:'u', newformat:'Y-m-d'},unformat: pickDate},
						{name:'name',index:'name', width:150,sortable:false,editable: true,editoptions:{size:"20",maxlength:"30"}},
						{name:'stock',index:'stock', width:70, sortable:false,editable: true,edittype:"checkbox",editoptions: {value:"Yes:No"},unformat: aceSwitch},
						{name:'ship',index:'ship', width:90, sortable:false,editable: true,edittype:"select",editoptions:{value:"FE:FedEx;IN:InTime;TN:TNT;AR:ARAMEX"}},
					...
					editurl:"${pageContext.request.contextPath}/transaction/editTransaction",
					caption: "交易列表",
					autowidth: true,
					//只有当点击复选框时，才客户选择
