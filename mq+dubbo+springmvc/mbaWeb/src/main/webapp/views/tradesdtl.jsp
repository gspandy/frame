			...
			<div class="main-content">
				...
				<div class="page-content">
					<form class="form-horizontal" role="form" id="searchform">
						<fieldset>
							<legend>查询条件</legend>
								<input type="hidden" id="docNum" name="docNum"/>
	...
	<script type="text/javascript">
			...
			jQuery(function($) {
				...
				jQuery(grid_selector).jqGrid({
					url:'${pageContext.request.contextPath}/trades/dtltradeslist',
					...
					height: 250,
					emptyrecords:true,
					colNames:['商品编码','数量','单价','折率','含税总金额','货物收入','货物税占比','货物销项税率','货物销项税额','服务收入','服务税占比','服务销项税率','服务销项税额','单位成本','成本金额','折让金额使用','备注'],
					colModel:[						
						{name:'goodsCode',index:'goodsCode', width:60, sortable:false,sorttype:"int", editable: false},
						{name:'quantity',index:'quantity', width:60, sortable:false,sorttype:"int", editable: false},
						{name:'price',index:'price',width:90, sortable:false,editable:true, sorttype:"date",formatter:'date',formatoptions:{srcformat:'u', newformat:'Y-m-d'},unformat: pickDate},
						{name:'disrate',index:'disrate', width:90,sortable:false,editable: false},
						{name:'intaxAmount',index:'intaxAmount', width:70, sortable:false,editable: false},
						{name:'goodsIncome',index:'goodsIncome', width:90, sortable:false,editable: false},
						{name:'goodsSaletaxScale',index:'goodsSaletaxScale', width:90, sortable:false,editable: false},
						{name:'goodsSaletax',index:'goodsSaletax', width:90, sortable:false,editable: false},
						{name:'goodsSaletaxamount',index:'goodsSaletaxamount', width:60, sortable:false,editable: false},				
						{name:'serviceIncome',index:'serviceIncome', width:60, sortable:false,editable: false},
						{name:'serviceSaletaxScale',index:'serviceSaletaxScale', width:60, sortable:false,editable: false},
						{name:'serviceSaletax',index:'serviceSaletax', width:60, sortable:false,editable: false},
						{name:'serviceSaletaxamount',index:'serviceSaletaxamount', width:60, sortable:false, editable: false},
						{name:'costPerunit',index:'costPerunit', width:60, sortable:false,editable: false},
						{name:'costAmount',index:'costAmount', width:60, sortable:false,editable: false},
						{name:'disAmount',index:'disAmount', width:60, sortable:false,editable: false},
						{name:'remarks',index:'remarks', width:60, sortable:false,editable: false}
					], 
					jsonReader : {  
